...
_lr_productions = [
  ...
  ('EMPTY -> <empty>','EMPTY',0,'p_empty','yacc.py',23),
  ('RELOP -> >','RELOP',1,'p_relop','yacc.py',28),
  ('RELOP -> <','RELOP',1,'p_relop','yacc.py',29),
  ('RELOP -> GRTREQL','RELOP',1,'p_relop','yacc.py',30),
  ('RELOP -> LESSEQL','RELOP',1,'p_relop','yacc.py',31),
  ('RELOP -> EQUAL','RELOP',1,'p_relop','yacc.py',32),
  ('RELOP -> NEQUAL','RELOP',1,'p_relop','yacc.py',33),
  ('TYPE -> INT','TYPE',1,'p_type','yacc.py',37),
  ('TYPE -> SHORT','TYPE',1,'p_type','yacc.py',38),
  ('TYPE -> CHAR','TYPE',1,'p_type','yacc.py',39),
  ('TYPE -> LONG','TYPE',1,'p_type','yacc.py',40),
  ('TYPE -> FLOAT','TYPE',1,'p_type','yacc.py',41),
  ('TYPE -> DOUBLE','TYPE',1,'p_type','yacc.py',42),
  ('Program -> ExtDefList','Program',1,'p_Program','yacc.py',46),
  ('ExtDefList -> ExtDef ExtDefList','ExtDefList',2,'p_ExtDefList','yacc.py',52),
  ('ExtDefList -> EMPTY','ExtDefList',1,'p_ExtDefList','yacc.py',53),
  ('FunHead -> Specifier FunDec','FunHead',2,'p_FunHead','yacc.py',61),
  ('ExtDecHead -> Specifier VarDec','ExtDecHead',2,'p_ExtDecHead','yacc.py',66),
  ('ExtDecList -> ExtDecList , VarDec','ExtDecList',3,'p_ExtDecList','yacc.py',76),
  ('ExtDecList -> ExtDecHead','ExtDecList',1,'p_ExtDecList','yacc.py',77),
  ('ExtDef -> ExtDecList ;','ExtDef',2,'p_ExtDef_ExtDecList','yacc.py',90),
  ('ExtDef -> Specifier ;','ExtDef',2,'p_ExtDef_Specifier','yacc.py',95),
  ('ExtDef -> FunHead CompSt','ExtDef',2,'p_ExtDef_FunDef','yacc.py',100),
  ('Specifier -> TYPE','Specifier',1,'p_Specifier','yacc.py',105),
  ('Specifier -> StructSpecifier','Specifier',1,'p_Specifier','yacc.py',106),
  ('StructSpecifier -> STRUCT OptTag { DefList }','StructSpecifier',5,'p_StructSpecifier','yacc.py',111),
  ('StructSpecifier -> STRUCT Tag','StructSpecifier',2,'p_StructSpecifier','yacc.py',112),
  ('OptTag -> ID','OptTag',1,'p_OptTag','yacc.py',120),
  ('OptTag -> EMPTY','OptTag',1,'p_OptTag','yacc.py',121),
  ('Tag -> ID','Tag',1,'p_Tag','yacc.py',126),
  ('VarDec -> ID','VarDec',1,'p_VarDec','yacc.py',131),
  ('VarDec -> ( VarDec )','VarDec',3,'p_VarDec','yacc.py',132),
  ('VarDec -> VarDec [ NUMBER ]','VarDec',4,'p_VarDec','yacc.py',133),
  ('VarDec -> FunDec','VarDec',1,'p_VarDec','yacc.py',134),
  ('VarDec -> * VarDec','VarDec',2,'p_VarDec_pointer','yacc.py',143),
  ('FunDec -> ID ( VarList )','FunDec',4,'p_FunDec','yacc.py',147),
  ('FunDec -> ID ( )','FunDec',3,'p_FunDec','yacc.py',148),
  ('VarList -> ParamDec , VarList','VarList',3,'p_VarList','yacc.py',156),
  ('VarList -> ParamDec','VarList',1,'p_VarList','yacc.py',157),
  ('ParamDec -> Specifier VarDec','ParamDec',2,'p_ParamDec','yacc.py',165),
  ('CompSt -> { DefList StmtList }','CompSt',4,'p_CompSt','yacc.py',170),
  ('StmtList -> Stmt StmtList','StmtList',2,'p_StmtList','yacc.py',175),
  ('StmtList -> EMPTY','StmtList',1,'p_StmtList','yacc.py',176),
  ('Stmt -> RETURN Exp ;','Stmt',3,'p_Stmt_return','yacc.py',184),
  ('Stmt -> PRINT ( Exp ) ;','Stmt',5,'p_Stmt_print','yacc.py',188),
  ('FlowCtrl -> IF ( Exp ) Stmt','FlowCtrl',5,'p_FlowCtrl','yacc.py',192),
  ('FlowCtrl -> IF ( Exp ) Stmt ELSE Stmt','FlowCtrl',7,'p_FlowCtrl','yacc.py',193),
  ('FlowCtrl -> WHILE ( Exp ) Stmt','FlowCtrl',5,'p_FlowCtrl','yacc.py',194),
  ('Stmt -> Exp ;','Stmt',2,'p_Stmt','yacc.py',205),
  ('Stmt -> CompSt','Stmt',1,'p_Stmt','yacc.py',206),
  ('Stmt -> ;','Stmt',1,'p_Stmt','yacc.py',207),
  ('Stmt -> FlowCtrl','Stmt',1,'p_Stmt','yacc.py',208),
  ('DefList -> Def ; DefList','DefList',3,'p_DefList','yacc.py',212),
  ('DefList -> EMPTY','DefList',1,'p_DefList','yacc.py',213),
  ('Def -> DecList','Def',1,'p_Def','yacc.py',221),
  ('DecHead -> Specifier Dec','DecHead',2,'p_DecHead','yacc.py',226),
  ('DecList -> DecHead','DecList',1,'p_DecList','yacc.py',231),
  ('DecList -> DecList , Dec','DecList',3,'p_DecList','yacc.py',232),
  ('Dec -> VarDec','Dec',1,'p_Dec','yacc.py',240),
  ('Dec -> VarDec = Exp','Dec',3,'p_Dec','yacc.py',241),
  ('PrefixedExp -> * Exp','PrefixedExp',2,'p_PrefixedExp_Mem','yacc.py',249),
  ('PrefixedExp -> & Exp','PrefixedExp',2,'p_PrefixedExp_Mem','yacc.py',250),
  ('SubTypeSpecifier -> EMPTY','SubTypeSpecifier',1,'p_SubTypeSpecifier','yacc.py',254),
  ('SubTypeSpecifier -> ( SubTypeSpecifier )','SubTypeSpecifier',3,'p_SubTypeSpecifier','yacc.py',255),
  ('SubTypeSpecifier -> * SubTypeSpecifier','SubTypeSpecifier',2,'p_SubTypeSpecifier_Mem','yacc.py',262),
  ('SubTypeSpecifier -> SubTypeSpecifier [ NUMBER ]','SubTypeSpecifier',4,'p_SubTypeSpecifier_Mem','yacc.py',263),
  ('SubTypeSpecifier -> SubTypeSpecifier ( TypeList )','SubTypeSpecifier',4,'p_SubTypeSpecifier_function','yacc.py',271),
  ('SubTypeSpecifier -> SubTypeSpecifier ( )','SubTypeSpecifier',3,'p_SubTypeSpecifier_function','yacc.py',272),
  ('TypeSpecifier -> TYPE SubTypeSpecifier','TypeSpecifier',2,'p_TypeSpecifier','yacc.py',280),
  ('TypeList -> TypeSpecifier','TypeList',1,'p_TypeList','yacc.py',285),
  ('TypeList -> TypeList , TypeSpecifier','TypeList',3,'p_TypeList','yacc.py',286),
  ('PrefixedExp -> - Exp','PrefixedExp',2,'p_PrefixedExp','yacc.py',293),
  ('PrefixedExp -> + Exp','PrefixedExp',2,'p_PrefixedExp','yacc.py',294),
  ('PrefixedExp -> PLUSSLF Exp','PrefixedExp',2,'p_PrefixedExp','yacc.py',295),
  ('PrefixedExp -> SUBSLF Exp','PrefixedExp',2,'p_PrefixedExp','yacc.py',296),
  ('PrefixedExp -> ( TypeSpecifier ) Exp','PrefixedExp',4,'p_PrefixedExp','yacc.py',297),
  ('Exp -> ( Exp )','Exp',3,'p_Exp_par','yacc.py',305),
  ('Exp -> ID','Exp',1,'p_Exp_Id','yacc.py',310),
  ('Exp -> NUMBER','Exp',1,'p_Exp_Number','yacc.py',314),
  ('Exp -> DECIMAL','Exp',1,'p_Exp_Constant_decimal','yacc.py',319),
  ('Exp -> STRINGLITERAL','Exp',1,'p_Exp_Constant_string','yacc.py',324),
  ('Exp -> Exp = Exp','Exp',3,'p_Exp','yacc.py',330),
  ('Exp -> Exp + Exp','Exp',3,'p_Exp','yacc.py',331),
  ('Exp -> Exp - Exp','Exp',3,'p_Exp','yacc.py',332),
  ('Exp -> Exp * Exp','Exp',3,'p_Exp','yacc.py',333),
  ('Exp -> Exp / Exp','Exp',3,'p_Exp','yacc.py',334),
  ('Exp -> FuncCall','Exp',1,'p_Exp','yacc.py',335),
  ('Exp -> PrefixedExp','Exp',1,'p_Exp','yacc.py',336),
  ('Exp -> Exp BOOLAND Exp','Exp',3,'p_Exp_Logic','yacc.py',343),
  ('Exp -> Exp BOOLOR Exp','Exp',3,'p_Exp_Logic','yacc.py',344),
  ('Exp -> ! Exp','Exp',2,'p_Exp_Logic','yacc.py',345),
  ('Exp -> Exp RELOP Exp','Exp',3,'p_Exp_Relop','yacc.py',352),
  ('Exp -> Exp [ Exp ]','Exp',4,'p_Exp_Mem','yacc.py',357),
  ('Exp -> Exp . ID','Exp',3,'p_Exp_Mem','yacc.py',358),
  ('FuncCall -> ID ( Args )','FuncCall',4,'p_FuncCall','yacc.py',366),
  ('FuncCall -> ID ( )','FuncCall',3,'p_FuncCall','yacc.py',367),
  ('Args -> Exp , Args','Args',3,'p_Args','yacc.py',375),
  ('Args -> Exp','Args',1,'p_Args','yacc.py',376),
]
